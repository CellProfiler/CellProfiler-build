%define _prefix /usr/cellprofiler
...
%define pref 	   %{_prefix}
%define python 	   /usr/cellprofiler/bin/python%{pyver}
...
%define pkgname    cellprofiler-wxpython
...
Requires: cellprofiler-python cellprofiler-libpng cellprofiler-libjpeg cellprofiler-zlib cellprofiler-libtiff cellprofiler-pyopengl-accelerate cellprofiler-pyopengl mesa-libGL mesa-libGLU
BuildRequires: gtk2-devel cellprofiler-pyopengl-accelerate cellprofiler-pyopengl mesa-libGL-devel mesa-libGLU-devel gcc gcc-c++
Prefix:    %{pref}
...
Provides:  cellprofiler-wxpython
